export default ({ app }, inject) => {
  ...
  inject("generalToast", ({ message = "" } = {}) => {
    app.$toast.show({
      ...
      message: message,
      timeout: 2,
      classToast: "bg-black -bottom-[165px] sm:-bottom-[245px] md:bottom-0",
      classTitle: "text-white",
      classMessage: "text-white",
      classClose: "text-white",
  ...
  inject("generalErrorToast", ({ message = "" } = {}) => {
    app.$toast.show({
      ...
      message: message,
      timeout: 2,
      classToast: "bg-red-500 -bottom-[165px] sm:-bottom-[245px] md:bottom-0",
      classTitle: "text-white",
      classMessage: "text-white",
      classClose: "text-white",
      classTimeout: "bg-black-300",
  ...
  inject("generalSuccessToast", ({ message = "" } = {}) => {
    app.$toast.show({
      ...
      message: message,
      timeout: 1,
      classToast: "bg-green-500 -bottom-[165px] sm:-bottom-[245px] md:bottom-0",
      classTitle: "text-white",
      classMessage: "text-white",
      classClose: "text-white",
      classTimeout: "bg-green-300",
