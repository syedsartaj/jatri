<template>
  <div class="bg-white">
    ...
    <div class="pt-80 lg:pt-20 px-4 lg:px-[100px] pb-[100px]">
      ...
      <div class="bg-bgShade3 rounded-[30px] pt-[60px] px-4 lg:px-[72px] pb-20">
        <div>
          <div class="">
            <h2 class="text-2xl lg:text-4xl text-blackPrimary text-center font-semibold lg:leading-[44px]">Why Choose Jatri</h2>
    ...
    <div class="p-4 lg:p-[100px] pt-0 flex justify-center">
      <div class="busOperatorbg rounded-[30px] px-4 lg:px-[60px] py-7 lg:py-10 w-full">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-x-[77px] gap-y-6 lg:gap-y-4 mt-8">
          <NuxtLink to="bus-operator?name=euro-coach" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold">Euro Coach</NuxtLink>
          <NuxtLink to="/bus-operator?name=sb-paribahan" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold">SB Paribahan</NuxtLink>
          <NuxtLink to="/bus-operator?name=greenline" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold">Greenline Paribahan</NuxtLink>
          ...
          <NuxtLink to="#" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold"> Ema Paribahan </NuxtLink>
          <NuxtLink to="/bus-operator?name=habib-paribahan" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold">Habib Paribahan</NuxtLink>
          <NuxtLink to="/bus-operator?name=saintmartin-bd-express" class="text-xs lg:text-base lg:leading-6 text-blackPrimary font-bold">Saintmartin BD Express</NuxtLink>
    ...
    <div class="bg-successLight py-10 lg:py-[60px] px-4 lg:px-[100px]">
      <div class="lg:flex justify-start gap-x-[103px]">
        <div class="w-full lg:w-1/2 flex justify-between items-center lg:block">
          ...
          <h2 class="text-2xl lg:text-[45px] lg:leading-[52px] text-blackPrimary font-medium lg:font-semibold lg:mt-8 order-first lg:order-last">Our most <br> popular routes</h2>
        </div>
    ...
    <div class="p-4 lg:p-[100px]">
      <div class="flex flex-wrap justify-between items-start gap-x-8">
        <div>
          ...
          <p class="text-blackLight text-sm leading-5 font-normal mt-4">Still need help? <span class="text-corporate underline"><a href="https://jatri.co/contact-us" target="_blank" class="">Contact Us</a> <img src="@/assets/images/icons/contact-rightArrow.svg" alt="" class="inline-block w-[5.19px] ml-[5.48px]"></span></p>
        </div>
        <div class="w-full lg:w-[710px] mt-6 lg:mt-0">
          ...
          <Accordion
            ...
            :details="`The easiest way to buy bus tickets online through Jatri is at your door now. First, you have to go the Jatri website: <a href='https://ticket.jatri.co/' class='text-blue-500 underline'>https://ticket.jatri.co/</a>
                        <br><br>Secondly, you will have to select your location, where to go, which kind of bus you need and the date of your journey. Then click the  <span class='text-blackPrimary font-bold'>“book now”</span> option and fill-up all the information. After making the payment process you will get your tickets.
                      `"
            :uniqeId="1"
            :selectedIndex="selectedAccordion"
            @setAccordionIndex="setAccordionIndex"
 ...
 First, you need to go to the search option. You need to add your phone number to search for your ticket.
                        <br>Click at the cancellation option. Your request will be submitted to our team.
                        <br>Your money will be refunded with following our refund & cancellation policy.
                        <br> <br>There are few cancellation policies: <br>
                        <br>
                     <span class='text-blackPrimary font-bold'>Auto cancellation</span> will happen if the customer fails to report at the reporting station before the departure time.
                        <br>
                        If the customer <span class='text-blackPrimary font-bold'>fails to pay</span> the full amount that mentioned in the screen will not get the activated tickets.
                        <br>
                        To be eligible for refund, customers need to cancel the ticket from jatri.co before the applicable time before the departure. And must report the cancelation to the support center (i.e Call 09642080808 or email to support@jatri.co) of Jatri.co
                        <br>
                        Only <span class='text-blackPrimary font-bold'>during Eid time</span> , customers are eligible for refund ONLY if the operator cancels the trip and cannot provide an alternative arrangement.
                       <span class='text-blackPrimary font-bold'>(Note:</span> Terms and conditions of refund policy might update or change from time to time without any notice)
                       <br>
                      <span class='text-blackPrimary font-bold'>For mobile payments</span>, it is the responsibility of the customer to input transaction ID (if applicable), PIN, OTP properly within time to confirm his ticket by himself.
                      <br>
                      ...
                      <br>
                      Tickets will be automatically canceled if the customer does not confirm payment within 30 minutes.
                      <br>
                      For mobile payments customers must complete payment and also verify transactions within this stipulated time.
                      <br>
