<template>
  <div>
    ...
    <div class="relative">
      <!-- banner section -->
      <img
        src="@/assets/images/home/searchBannerImageWeb.svg"
        alt=""
        class="w-full hidden lg:block"
      />
      <div class="hidden lg:block">
        <div
          class="flex items-center justify-center absolute m-auto top-0 bottom-0 right-[100px] left-[100px] z-40"
        >
          <SearchFilterForm />
        </div>
      </div>
      ...
      <div class="relative">
        <img
          src="@/assets/images/home/searchBannerImageMobile.svg"
          alt=""
      ...
      <div class="block lg:hiddden" v-if="tripFilterModify">
        <TripFilterModal
          :close="handleTripFilterModal"
          @handleTripFilterModal="handleTripFilterModal"
        />
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    filterQueryData() {
      const formattedDate = new Date(+this.$route.query.date).toLocaleString(
        "en-CA",
        {
          dateStyle: "short",
        }
      ...
      return {
        ...
        condition: this.$route.query.type,
      };
    },
  },
