<template>
     <button 
          class="flex justify-between items-center w-1/2 rounded-lg px-5 py-[15px] border" 
          :class="activePlan === planName ? 'bg-[#EFF7FD] border-[#1E88E5]' : 'bg-[#f7f7f7] border-[#f7f7f7]'"
     ...
     >
          ...
          <img v-if='activePlan === planName' src="@/assets/images/icons/tik-blue.svg" alt="tik">
     </button>
</template>
<script>
export default {
     ...
     props: ['planName', 'planIcon', 'planDiscount', 'activePlan'],
     methods: {
          updateActivePlan () {
