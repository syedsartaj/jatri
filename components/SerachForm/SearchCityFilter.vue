<template>
     <div class="w-1/4 px-6 py-4">
          ...
          <!-- dropdown -->
          <div class='mt-[40px] -ml-5 xl:w-[380px] w-80 bg-white rounded-md shadow-xl z-[1000] leading-6 before:block before:-mt-2 before:ml-20 before:-skew-y-3 before:bg-white before:h-5 before:w-5 before:rotate-45 absolute divide-y-2'>
               ...
               <ul class='overflow-y-auto divide-y divide-dashed h-[344px] text-sm xl:text-md text-td_text px-4'>
                    <li class='cursor-pointer font-inter py-[14px] font-medium text-corporate hover:text-corporate relative'>
                         Dhaka
                         <span class='absolute right-5 top-5 bottom-0'><img src="@/assets/images/icons/tik.svg" alt="" class="w-4 h-3"></span>
                    </li>
                    <li class='cursor-pointer font-inter py-[14px] font-normal hover:text-corporate relative'>
                         Dhaka
                    </li>
                    <li class='cursor-pointer font-inter py-[14px] font-normal hover:text-corporate relative'>
                         Dhaka
