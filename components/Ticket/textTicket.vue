<template>
  ...
  >
    <img
      ...
      alt=""
      style="height: 44px; background-repeat: no-repeat; object-fit: cover"
    />
    <img
      v-else
    ...
    >
      <!-- ========= Passenger Details ========= -->
      <table style="width: 563px; width: 100%">
        <tr>
          <td
            colspan="2"
            style="
        ...
        <tr>
          <td
            style="
              ...
              border-top: none;
              border-right: 1px solid #fde5e2;
              border-bottom: 1px solid #fde5e2;
              border-left: 1px solid #fde5e2;
          ...
          >
            <table style="width: 100%">
              <tr>
                <td>
                  <table style="font-size: 12px; line-height: 16px; background-color: #b6b6b6">
                    <tr>
                      <td style="color: #494949; font-weight: 400; padding-bottom: 8px;  padding-right: 14px;">Name</td>
                      <td style="font-weight: 500; padding-bottom: 8px;">
                        {{ ticketDetails.passenger.name }}
                      </td>
                    </tr>
                    <tr>
                      <td style="color: #494949; font-weight: 400; padding-right: 14px;">
                        Mobile Number
                      </td>
                ...
                <td>
                  <table style="font-size: 12px; line-height: 16px; background-color: #b6b6b6;">
                    <tr>
                      <td style="color: #494949; font-weight: 400; padding-bottom: 8px;">Bus Type</td>
                      <td style="font-weight: 500;">
                        {{
                          serviceType === "BUS"
                    ...
                    <tr>
                      <td style="color: #494949; font-weight: 400;">
                        Selected Seat
                      </td>
                      <td>
                        <table
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p
                    v-if="ticketDetails.droppingPoint"
                ...
                <div v-for="(tickets, i) in seatFareArray" :key="i">
                  ...
                  >
                    Ticket Fare Seat (<span
                      ...
                      :key="sit"
                      >{{ sit
                      }}<span v-if="index != tickets.seat.length - 1"
                        >,</span
                      ></span
                    >)
                  </p>
      ...
      <tr>
        <td style="width: 50%">
          <div style="display: flex">
            <p style="margin: 0; color: #fff">Powered by:</p>
            <img
              :src="require('@/assets/images/ticket/logo-white.png')"
              alt=""
              style="height: 16px; vertical-align: middle; margin-left: 10px"
            />
          </div>
        </td>
        <td style="text-align: right; width: 50%">
          <p style="margin: 0">www.jatri.co</p>
        </td>
      </tr>
    </table>
  </div>
