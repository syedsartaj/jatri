<template>
  <div style="width: 100%; font-family: 'Inter', sans-serif">
    ...
    <div
      style="
        background-color: #f04935 !important;
        height: 44px;
        padding-left: 30px;
        padding-top: 10px;
      "
    ...
    <div style="padding-left: 24px; padding-right: 24px">
      ...
      <div style="display: flex">
        ...
        <div style="width: 40%; border: 2px solid #fde5e2; border-radius: 8px">
          <p
            style="
              padding: 8px 8px 8px 12px;
              background-color: #fde5e2;
          ...
          <div style="width: 49%; margin-left: 16px">
            ...
            >
              ...
              <li>
                ...
                apply for a refund within 24 hours of the trip departure time.
              </li>
            </ul>
            <p
              style="
      ...
      <!-- ========= social part =========  -->
      <div v-if="ticketDetails.tripType === 'eid'" class="flex justify-between">
        <div>
          <div
            style="
              display: flex;
        ...
        <img
          ...
          alt="eidStamp"
          style="top: 638px; left: 650px; position: absolute"
        />
      </div>
      <div
        v-else
    ...
    <!-- ========= Footer part ========= -->
    <div style="background-color: #f04935 !important; padding: 12px 16px">
