...
export default {
      ...
      if (this.getLaunchBookingData?.gatewayType !== this.gatewayType) {
        try {
          ...
          if (
            ...
            this.handleSeveralPaymentAttempt(this.getLaunchBookingData.invoice);
          }
  ...
  methods: {
    ...
    applyPromo() {
      // TODO: handle several payment attempt if promo is enabled for launch
      // this.$nextTick(async () => {
          ...
          try {
            ...
            if (
              ...
              this.handleSeveralPaymentAttempt(
                this.getLaunchBookingData.invoice
              );
            }
